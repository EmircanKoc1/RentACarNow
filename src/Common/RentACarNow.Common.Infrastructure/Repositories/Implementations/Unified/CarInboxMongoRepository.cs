...
{
    public class CarInboxMongoRepository : BaseInboxMongoRepository<CarInboxMessage, MongoCarInboxContext>, ICarInboxRepository
    {
        public CarInboxMongoRepository(MongoCarInboxContext context) : base(context)
        {
        }
    }
